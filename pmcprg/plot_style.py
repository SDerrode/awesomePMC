"""
pmcprg.plot_style — package-wide matplotlib defaults.
...
Usage
-----
The plotting code in ``pmcprg.copulas`` imports this once at package init.
End-users wanting to customise styling can either:
  * call ``apply_style(font_size=14, dpi=200)`` after importing pmcprg, or
